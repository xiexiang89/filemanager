...
import com.edgar.filemanager.utils.Preconditions;

import java.util.HashMap;
import java.util.List;
import java.util.Locale;

import static com.edgar.filemanager.utils.Utils.HAS_NOUGAT;
...
public class MediaFile {
    ...
    private static final int FORMAT_HEIF = 0x3812;
    // Audio file types
...
//        }
        ...
        addFileType("HEIC", FILE_TYPE_HEIF, "image/heif", FORMAT_HEIF, true);
        addFileType("HEIF", FILE_TYPE_HEIF, "image/heif", FORMAT_HEIF, false);
